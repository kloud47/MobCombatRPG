...
void UHeroCombatComponent::RegisterSpawnedWeapon(FGameplayTag InWeaponTagToRegister,
...
AWarriorWeaponBase* UHeroCombatComponent::GetCharacterCarriedWeaponByTag(FGameplayTag InWeaponTagToGet) const
{
...
AWarriorWeaponBase* UHeroCombatComponent::GetCharacterCurrentEquippedWeapon() const
{
